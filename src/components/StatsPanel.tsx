    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {stats.map((stat, index) => {
          ...
          return (
            <Card key={index} className="bg-gray-700/50 border-gray-600/50 backdrop-blur-sm hover:bg-gray-700/70 transition-all duration-300">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="flex items-center justify-between p-3 bg-gray-600/30 rounded-lg">
                <div>
                  <p className="font-medium text-white">{activity.exercise}</p>
                  <p className="text-sm text-gray-400">{activity.sets} • {activity.weight}</p>
                </div>
